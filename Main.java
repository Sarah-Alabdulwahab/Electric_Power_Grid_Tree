...
public class Main {
	...
	private static GT<PGElem> buildPG() {
      ...
      PowerGridUtils.attach(pg, new PGElem(4, ElemType.Transmitter, 18), 3);
		...
		PowerGridUtils.attach(pg, new PGElem(50, ElemType.Transmitter, 12), 7);
		PowerGridUtils.attach(pg, new PGElem(51, ElemType.Consumer, 12), 50);
		PowerGridUtils.attach(pg, new PGElem(52, ElemType.Consumer, 12), 50);
		PowerGridUtils.attach(pg, new PGElem(53, ElemType.Consumer, 12), 50);
*/
